...
//
//     final dateWordModel = dateWordModelFromJson(jsonString);

import 'dart:convert';

DateWordModel dateWordModelFromJson(String str) =>
    DateWordModel.fromJson(json.decode(str));

String dateWordModelToJson(DateWordModel data) => json.encode(data.toJson());
...
class DateWordModel {
  ...
  factory DateWordModel.fromJson(Map<String, dynamic> json) => DateWordModel(
